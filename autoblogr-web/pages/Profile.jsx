// Profile.js - User profile settings page component
...
export default function Profile() {
  ...
  const loadUserData = async () => {
    ...
    try {
      // Use Clerk user data instead of User.me()
      const userData = {
        id: clerkUser.id,
        email: clerkUser.primaryEmailAddress?.emailAddress || "",
        name: clerkUser.fullName || "",
        // Add any existing profile data from our database if needed
      };
      setUser(userData);
      ...
      setFormData((prev) => ({
        ...
        content_preferences: {
          preferred_length:
            userData.content_preferences?.preferred_length || "medium",
        ...
        <form onSubmit={handleSave} className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData((prev) => ({ ...prev, brand_voice: value }))
                    }
                  >
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-600">
                      Automatically generate hero images for blog posts
                    </p>
                  </div>
                  <Switch
          ...
          <Alert className="border-blue-200 bg-blue-50">
            ...
            <AlertDescription className="text-blue-800">
              These settings will be used as defaults when generating new blog
              content. You can always customize individual posts.
            </AlertDescription>
          </Alert>
